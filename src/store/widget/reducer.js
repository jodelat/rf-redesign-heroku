...
const widgetDetailReducer = getMetaDataReducer({ baseType: widgetConstants.WIDGET_DETAIL })
const widgetGroupReducer = getMetaDataReducer({ baseType: widgetConstants.WIDGET_GROUP })

export default combineReducers({
    widgetDetail: widgetDetailReducer,
